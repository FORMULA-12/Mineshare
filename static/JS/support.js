...
function changeGradient(gradient) {
    ...
    if (gradient == "Голубой") {
        ...
        element.value = "Голубой"
    } else if (gradient == "Красный") {
        text.innerText = "Текущий градиент: Красный";
        element.value = "Красный";
    } else if (gradient == "Фиолетовый") {
        text.innerText = "Текущий градиент: Фиолетовый";
        element.value = "Фиолетовый"
    } else if (gradient == "Оранжевый") {
        text.innerText = "Текущий градиент: Оранжевый";
        element.value = "Оранжевый"
    } else if (gradient == "Зеленый") {
        text.innerText = "Текущий градиент: Зеленый";
        element.value = "Зеленый"
    } else {
        text.innerText = "Текущий градиент: Розовый";
        element.value = "Розовый"
    }
}
